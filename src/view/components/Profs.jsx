    ...
    return (
      ...
      >
        ...
        >
          <TableHead>
            <TableRow>
              <StyledTableCell>Noms de professeurs</StyledTableCell>
              <StyledTableCell align="left">Cours</StyledTableCell>
              <StyledTableCell align="left">Assistants</StyledTableCell>
              <StyledTableCell align="left">Nbr d'heures</StyledTableCell>
          ...
          <TableBody>
            ...
            >
              <StyledTableCell component="th" scope="row">
                <Typography variant="h5"> Prof Baraka</Typography>
              </StyledTableCell>
              ...
              <StyledTableCell align="left">
                <Typography variant="h6">Kabangu john</Typography>
              </StyledTableCell>
              <StyledTableCell align="left">
                <Typography variant="h6">245h</Typography>
              </StyledTableCell>
              <StyledTableCell align="left">
                <p
                  style={{
            ...
            >
              <StyledTableCell component="th" scope="row">
                <Typography variant="h5"> Kabangu john</Typography>
              </StyledTableCell>
              <StyledTableCell align="left">
                <Box
                  sx={{
              ...
              <StyledTableCell align="left">
                <Typography variant="h6">Prof Baraka</Typography>
              </StyledTableCell>
              <StyledTableCell align="left">
                <Typography variant="h6">205h</Typography>
              </StyledTableCell>
              <StyledTableCell align="left">
                <p
                  style={{
            ...
            >
              ...
              <StyledTableCell align="left">
                <Typography variant="h6">Ishara fiston</Typography>
              </StyledTableCell>
              <StyledTableCell align="left">
                <Typography variant="h6">145h</Typography>
              </StyledTableCell>
              <StyledTableCell align="left">
                <p
                  style={{
